...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA3     ------> ADC1_IN4
    */
    GPIO_InitStruct.Pin = HV1P_Pin|HV1N_Pin|HVIP_Pin|HVIN_Pin;
  ...
  */
    ...
    PA6     ------> ADC2_IN3
    */
    GPIO_InitStruct.Pin = SIN_Pin|COS_Pin|I_O_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOA, HV1P_Pin|HV1N_Pin|HVIP_Pin|HVIN_Pin);
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PA6     ------> ADC2_IN3
    */
    HAL_GPIO_DeInit(GPIOA, SIN_Pin|COS_Pin|I_O_Pin);
...
void HAL_COMP_MspInit(COMP_HandleTypeDef* hcomp)
{
  ...
  if(hcomp->Instance==COMP1)
  {
    ...
    PA1     ------> COMP1_INP
    */
    GPIO_InitStruct.Pin = HV1P_Pin|HV1N_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  else if(hcomp->Instance==COMP2)
  {
    ...
    PA3     ------> COMP2_INP
    */
    GPIO_InitStruct.Pin = HVIP_Pin|HVIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* hcomp)
{
  if(hcomp->Instance==COMP1)
  {
    ...
    PA1     ------> COMP1_INP
    */
    HAL_GPIO_DeInit(GPIOA, HV1P_Pin|HV1N_Pin);
  ...
  else if(hcomp->Instance==COMP2)
  {
    ...
    PA3     ------> COMP2_INP
    */
    HAL_GPIO_DeInit(GPIOA, HVIP_Pin|HVIN_Pin);
